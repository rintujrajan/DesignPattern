...
The Subject Interface would have the methods to 
	...
	-> Remove observer - renove existing obervers
...
the three above mentioned methods of the subject interface. The Notify Observor 
...
Observer Interface and implememts the update method

Each Concrete Observer has to register themselves to a Concrete Subject. It is 
done in the constructor of the Concrete Obsevers(Dsiplay classes) in the 
current code. 
...
int main()
{
	...
	// 2nd sample data set - only 2nd observer now observing
	...
	// 3rd sample data set - no observers left
